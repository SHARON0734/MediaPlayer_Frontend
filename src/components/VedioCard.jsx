...
const handleClose = () => setShow(false);
 const handleShow = async() => {
  ...
  let timestamp = new Intl.DateTimeFormat('en-GB',{year:'numeric',month:'2-digit',day:'2-digit',hour:'2-digit',second:'2-digit'}).format(today)
...
const dragStart = (e,id)=>{
  ...
  // to transfer id from video card to category 
